							...
							<div class="frm" id="sf1">
								<fieldset class="scheduler-border">
									...
									<!--<div class="form-group" style="margin-top:2%;">
										<label class="col-lg-2 control-label" for="admission_quota">Admission-quota <span class="text-danger">*</span></label>
										<div class="col-lg-6">
								...
								<fieldset id="" class="scheduler-border" style="width:auto">
									...
									<div class="form-group">
										<div class="col-md-10 col-lg-offset-2">
											...
											<button class="btn btn-primary open4" value="open4" type="button">Submit &nbsp;<span class="fa fa-arrow-right"></span></button>
				...
				else
				{
					if(v.valid() == true)
					{
						...
						$.ajax({
							...
							cache: false,
							url: 'live_search.php',
							data: $("#student_form").serialize() + "&key=form_data_update",
							beforeSend: function(){
								$("#loader").show();
							},
							...
							{
								//alert(resp);
								//$('.panel-footer').html(resp);
								$("#loader").hide();
								if(resp == 'update ok'){
									//alert("inside if");
									$("#student_form").html('<h3 class="text-success">Record has been Updated Successfully!</h3>');
									var but = $('<button/>', {
									text: 'Goback', //set text 1 to 10
									id: 'add_another_one',
									class: 'btn btn-info btn-flat input-sm',
									click: function () { alert('Click ok'); }//location.reload();
								});
